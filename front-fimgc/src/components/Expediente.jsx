...
import { Tab, Tabs, Container, Form, FormCheck, ListGroup, InputGroup, Button, Row, Col, Table, Modal, Alert, OverlayTrigger, Tooltip } from 'react-bootstrap';
...
const Expediente = () => {
    ...
    const verificarExp = async () => {
        ...
        try {
            ...
            setInteresadoEmail(veriResponse.data.interesado.email)
        ...
        axios
            ...
            .then((response) => {
                if (response.data && response.data.length > 0) {
                    ...
                    setMiembroId(response.data[0].id);
                } else {
        ...
        axios
            ...
            .then((response) => {
                if (response.data && response.data.length > 0) {
                    ...
                    setPresidenteId(response.data[0].id);
                } else {
                    console.log('La respuesta del servidor está vacía o incompleta.');
                }
            })
            ...
            <Container>
                ...
                <Modal aria-labelledby="modal-previsulizacion" size="lg" show={modalDatosBH2}>
                    ...
                    <Modal.Footer>
                        ...
                        <Button variant="outline-dark" onClick={enviarCorreo} >Confirmar  <i className="fi fi-bs-paper-plane"></i></Button>
