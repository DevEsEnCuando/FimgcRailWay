...
import { Container, Form, Table, InputGroup, Button, Row, Col, Alert, Modal } from 'react-bootstrap';
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post(
        `http://localhost:8080/api/expediente/4/expedienteUserEscuelaBorrador?asesorId=${asesorId}&miembroId=${miembroId}&presidenteId=${presidenteId}&escuelaId=${selectedEscuelaId}&telefono=${telefono}`,
        expedienteData,
        {
          headers: {
        ...
        <Form onSubmit={handleSubmit}>
          <fieldset className='customize-fielset'>
            ...
            <Form.Group as={Row} className="mb-3">
              ...
              <Col sm="3">
                <Form.Control type="text" id="nroExpediente" name="nroExpediente" placeholder="Ejemplo:232543.001" value={expediente.nroExpediente} onChange={handleInputChange2} />
              </Col>
            ...
            <Form.Group as={Row} className="mb-3">
              ...
              <Col sm="8">
                <InputGroup>
                  <Form.Control type="text" id="nombreAsesor" name="nombreAsesor" placeholder="Ingrese el nombre de su asesor." value={nombreAsesor} onChange={handleAsesorChange} />
            ...
            <Form.Group as={Row} className="mb-3">
              ...
              <Col sm="3">
                <Form.Control type="text" id="nroMMAprobacionPlan" name="nroMMAprobacionPlan" placeholder="Ejemplo: 7, 14, 156"
                  aria-label="Ingrese el número de expediente." value={expediente.nroMMAprobacionPlan}
            ...
            <Form.Group as={Row} className="mb-3">
              ...
              <Col sm="3">
                <Form.Control type="text" id="nroRDAprobacionPlan" name="nroRDAprobacionPlan" placeholder="Ejemplo: 7, 14, 156"
                  aria-label="Ingrese el número de expediente." value={expediente.nroRDAprobacionPlan}
                  aria-describedby="basic-addon1" onChange={handleInputChange2}
                />
              </Col>
