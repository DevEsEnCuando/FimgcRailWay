...
const TramitarBachiller = () => {
  ...
  const tooltipsMensajes = {
    ...
    resolucionIngreso:
      "Ejemplo: Resolución de Consejo Universitario Nº0215-2015-UNSCH-CU",
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post(
        `http://localhost:8080/api/expediente/4/expedienteUserEscuelaBachiller?escuelaId=${selectedEscuelaId}&modalidadIngresoId=${selectedModalidadId}&telefono=${telefono}`,
        expedienteData,
        {
          headers: {
            ...
            <Form.Group as={Row} className="mb-3">
              ...
              <Col sm="3">
                <Form.Control required type="text" name="telefono" value={
                  telefono} onChange={handleInputChange2} placeholder="Ingrese el número de celular." />
              </Col>
            </Form.Group>
            {showAlertBH && (
